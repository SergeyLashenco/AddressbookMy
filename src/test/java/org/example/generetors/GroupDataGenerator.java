package org.example.generetors;
...
public class GroupDataGenerator {
   /**
    * В Edit Configuration...  в Program arguments указать количество создаваемых групп и путь Файла в данном случае (-c 10 -f src/test/resources/groups.json )
    */
